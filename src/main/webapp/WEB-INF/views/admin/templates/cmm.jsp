...
<jsp:include page="/WEB-INF/views/admin/templates/nav.jsp" flush="false"/>
<jsp:include page="/WEB-INF/views/admin/templates/aside.jsp" flush="false"/>
