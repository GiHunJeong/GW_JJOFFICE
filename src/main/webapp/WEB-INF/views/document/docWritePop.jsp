      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div style="text-align: center; margin-top: 10px;">
            <div style="display:inline-block;"><button type="button" class="btn btn-block btn-outline-primary" onclick="docWritePop.docWriteAction();">작성</button></div>
            <div style="display:inline-block;"><button type="button" class="btn btn-block btn-outline-danger" onclick="docWritePop.docCancelAction();">취소</button></div>
          </div>
        </div>
      </div>
    </div>
...
<!--  -->
<script type="text/javascript" src="/js/jjoffice/document/docWritePop.js"></script>
<script>
  docWritePop.init();
</script>